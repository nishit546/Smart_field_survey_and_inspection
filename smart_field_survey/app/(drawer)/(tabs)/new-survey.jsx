...
export default function NewSurveyScreen() {
    ...
    const [priority, setPriority] = useState(tempSurvey.priority || 'Medium');
    ...
    const handleReset = () => {
        Alert.alert('Reset Form', 'Are you sure you want to clear all fields and attachments?', [
    ...
    return (<View style={[styles.mainContainer, { backgroundColor: isDark ? '#151718' : '#f8fafc' }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        ...
        ]} value={siteName} placeholder="e.g. Hydroelectric Dam Section A" placeholderTextColor="#94a3b8" onChangeText={(text) => handleTextChange('siteName', text)} onBlur={() => validateField('siteName', siteName)}/>
        ...
        ]} value={clientName} placeholder="e.g. Apex Utilities Ltd" placeholderTextColor="#94a3b8" onChangeText={(text) => handleTextChange('clientName', text)} onBlur={() => validateField('clientName', clientName)}/>
        ...
        ]} value={description} placeholder="Describe the scope, objectives, or instructions for this inspection..." placeholderTextColor="#94a3b8" multiline numberOfLines={4} onChangeText={(text) => handleTextChange('description', text)} onBlur={() => validateField('description', description)}/>
        ...
        ]} value={date} placeholder="YYYY-MM-DD" placeholderTextColor="#94a3b8" onChangeText={(text) => handleTextChange('date', text)} onBlur={() => validateField('date', date)}/>
              <Pressable style={[styles.todayButton, { backgroundColor: '#6d28d9' }]} onPress={() => handleTextChange('date', new Date().toISOString().split('T')[0])}>
          ...
          <View style={styles.attachmentList}>
            ...
            <View style={[styles.attachmentItem, { borderBottomColor: isDark ? '#334155' : '#f1f5f9' }]}>
              <View style={styles.attachmentMeta}>
                <Ionicons name={tempSurvey.photoUri ? 'checkmark-circle' : 'camera-outline'} size={24} color={tempSurvey.photoUri ? '#10b981' : '#94a3b8'}/>
                <View>
              ...
              <Pressable style={[styles.attachButton, { backgroundColor: isDark ? '#0f172a' : '#f1f5f9' }]} onPress={() => router.push('/(drawer)/camera')}>
            ...
            <View style={[styles.attachmentItem, { borderBottomColor: isDark ? '#334155' : '#f1f5f9' }]}>
              <View style={styles.attachmentMeta}>
                <Ionicons name={tempSurvey.latitude ? 'checkmark-circle' : 'location-outline'} size={24} color={tempSurvey.latitude ? '#10b981' : '#94a3b8'}/>
                <View>
                  <Text style={[styles.attachmentLabel, { color: isDark ? '#f1f5f9' : '#1e293b' }]}>
                    GPS Coordinates
                  </Text>
            ...
            : 'No location coordinates linked'}
              ...
              <Pressable style={[styles.attachButton, { backgroundColor: isDark ? '#0f172a' : '#f1f5f9' }]} onPress={() => router.push('/(drawer)/location')}>
                <Text style={[styles.attachButtonText, { color: '#6d28d9' }]}>
            ...
            <View style={[styles.attachmentItem, { borderBottomColor: isDark ? '#334155' : '#f1f5f9' }]}>
              <View style={styles.attachmentMeta}>
                <Ionicons name={tempSurvey.contactName ? 'checkmark-circle' : 'person-outline'} size={24} color={tempSurvey.contactName ? '#10b981' : '#94a3b8'}/>
                <View>
                  <Text style={[styles.attachmentLabel, { color: isDark ? '#f1f5f9' : '#1e293b' }]}>
                    Client Contact
                  </Text>
            ...
            : 'No contact selected'}
              ...
              <Pressable style={[styles.attachButton, { backgroundColor: isDark ? '#0f172a' : '#f1f5f9' }]} onPress={() => router.push('/(drawer)/contacts')}>
                <Text style={[styles.attachButtonText, { color: '#6d28d9' }]}>
            ...
            <View style={styles.attachmentItem}>
              <View style={styles.attachmentMeta}>
                <Ionicons name={tempSurvey.notes ? 'checkmark-circle' : 'clipboard-outline'} size={24} color={tempSurvey.notes ? '#10b981' : '#94a3b8'}/>
                <View>
                  <Text style={[styles.attachmentLabel, { color: isDark ? '#f1f5f9' : '#1e293b' }]}>
                    Clipboard Notes
                  </Text>
              ...
              <Pressable style={[styles.attachButton, { backgroundColor: isDark ? '#0f172a' : '#f1f5f9' }]} onPress={() => router.push('/(drawer)/clipboard')}>
                <Text style={[styles.attachButtonText, { color: '#6d28d9' }]}>
