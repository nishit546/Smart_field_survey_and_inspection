    ...
    return (<View style={[styles.mainContainer, { backgroundColor: isDark ? '#151718' : '#f8fafc' }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.gridContainer}>
          {quickActions.map((action, index) => (<Pressable key={index} style={({ pressed }) => [
                styles.gridCard,
                {
        ...
        {recentSurveys.length === 0 ? (<View style={[styles.emptyCard, { backgroundColor: isDark ? '#1e293b' : '#ffffff' }]}>
            <Ionicons name="file-tray-outline" size={48} color="#94a3b8"/>
            <Text style={[styles.emptyText, { color: isDark ? '#94a3b8' : '#64748b' }]}>
              No surveys created yet.
            </Text>
            <Pressable style={styles.emptyButton} onPress={() => router.push('/(drawer)/(tabs)/new-survey')}>
              <Text style={styles.emptyButtonText}>Create Survey</Text>
            </Pressable>
          </View>) : (<View style={styles.recentList}>
            {recentSurveys.map((survey) => (<Pressable key={survey.id} style={({ pressed }) => [
                    styles.recentCard,
                    {
                        backgroundColor: isDark ? '#1e293b' : '#ffffff',
                ...
                <View style={styles.recentCardHeader}>
                  ...
                  <View style={[
                    ...
                    {
                        backgroundColor: survey.priority === 'High' ? '#fee2e2' :
                ...
                <View style={styles.recentFooter}>
                  ...
                  {survey.photoUri && (<View style={styles.recentMeta}>
