...
export default function CameraScreen() {
    ...
    const [localPhotoUri, setLocalPhotoUri] = useState(tempSurvey.photoUri);
    const [localCaptureTime, setLocalCaptureTime] = useState(tempSurvey.photoCaptureTime);
    // If permission is still loading
    if (!permission) {
        return (<View style={[styles.loadingContainer, { backgroundColor: isDark ? '#151718' : '#f8fafc' }]}>
    ...
    if (!permission.granted) {
        return (<View style={[styles.permissionContainer, { backgroundColor: isDark ? '#151718' : '#f8fafc' }]}>
        <View style={styles.permissionCard}>
          ...
          <Pressable style={[styles.primaryBtn, { backgroundColor: '#6d28d9' }]} onPress={requestPermission}>
            <Text style={styles.primaryBtnText}>Grant Permission</Text>
          </Pressable>

          {!permission.canAskAgain && (<Pressable style={styles.secondaryBtn} onPress={() => Linking.openSettings()}>
              <Text style={styles.secondaryBtnText}>Open System Settings</Text>
            </Pressable>)}

          <Pressable style={styles.backBtn} onPress={() => router.push('/(drawer)/(tabs)/new-survey')}>
    ...
    if (localPhotoUri) {
        ...
        <Pressable style={[styles.closePreviewBtn, { top: insets.top + 16 }]} onPress={handleSaveAndExit}>
    ...
    return (<View style={styles.cameraContainer}>
      <CameraView style={StyleSheet.absoluteFillObject} facing="back" ref={cameraRef} onCameraReady={() => setIsCameraReady(true)}/>
      ...
      <View style={[styles.topControls, { paddingTop: insets.top + 10 }]}>
        <Pressable style={styles.circularBackBtn} onPress={() => router.push('/(drawer)/(tabs)/new-survey')}>
      ...
      <View style={[styles.bottomControls, { paddingBottom: insets.bottom + 20 }]}>
        ...
        <Pressable style={({ pressed }) => [
          ...
          {isCapturing ? (<ActivityIndicator size="large" color="#6d28d9"/>) : (<View style={styles.captureInnerCircle}/>)}
        </Pressable>
