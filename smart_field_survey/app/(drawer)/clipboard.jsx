...
export default function ClipboardScreen() {
    ...
    return (<View style={[styles.mainContainer, { backgroundColor: isDark ? '#151718' : '#f8fafc' }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        ...
        <View style={[styles.card, { backgroundColor: isDark ? '#1e293b' : '#ffffff' }]}>
          ...
          <View style={styles.parameterList}>
            ...
            <View style={[styles.paramRow, { borderBottomColor: isDark ? '#334155' : '#f1f5f9' }]}>
              ...
              <Pressable style={styles.actionIconBtn} onPress={() => handleCopyText(surveyId, 'Survey ID')}>
            ...
            <View style={[styles.paramRow, { borderBottomColor: isDark ? '#334155' : '#f1f5f9' }]}>
              ...
              <Pressable style={[styles.actionIconBtn, { opacity: contactNumber ? 1 : 0.4 }]} disabled={!contactNumber} onPress={() => handleCopyText(contactNumber, 'Contact Number')}>
                <Ionicons name="copy-outline" size={20} color="#6d28d9"/>
              </Pressable>
            </View>
            ...
            <View style={styles.paramRow}>
              ...
              <Pressable style={[styles.actionIconBtn, { opacity: coordinates ? 1 : 0.4 }]} disabled={!coordinates} onPress={() => handleCopyText(coordinates, 'GPS Coordinates')}>
                <Ionicons name="copy-outline" size={20} color="#6d28d9"/>
              </Pressable>
            </View>
          </View>
        ...
        ]} value={notes} placeholder="No notes compiled yet. Use clipboard paste or write manually..." placeholderTextColor="#94a3b8" multiline numberOfLines={6} onChangeText={handleNotesChange}/>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? '#1e293b' : '#ffffff' }]}>
          ...
          <Pressable style={[styles.adminBtn, { backgroundColor: isDark ? '#0f172a' : '#f1f5f9' }]} onPress={handleClearClipboard}>
